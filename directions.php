...
$dirResult=mysqli_query($conn, $testsSQL);
$dirRow=mysqli_fetch_array($dirResult);
...
<?php
	  ...
	  //se a variável myVar for diferente de NULL
	  if (!isset($myVar)) {
	  ...
	  ?>
        <div align="center">
          ...
          <form name="form1" method="post" action="userInfo.php">
            ...
            <input class="css_btn_class" type="submit" value="<?=CONTINUE_BUTTON?>">
          </form>
          </div>
		<?php
		?>
