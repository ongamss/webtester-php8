...
?> 
    ...
    <tr> 
      <td colspan="2" align="left" valign="top"> <div class="hr">
        ...
        <p align="center"><font size="+1"><strong>Muitas tentativas</strong></font></p>
        <p>Voc&ecirc; n&atilde;o est&aacute; autorizado a fazer este teste. Foi excedido o n&uacute;mero m&aacute;ximo de tentativas . </p>
        <form name="form1" method="post" action="index.php">
          <input class="css_btn_anteior" type="submit" value="COME&Ccedil;AR NOVAMENTE">
        </form>
        <p>&nbsp;</p>
