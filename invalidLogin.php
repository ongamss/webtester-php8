...
?> 
    ...
    <tr> 
      <td colspan="2" align="left" valign="top"> <div class="hr">
        ...
        <p align="center"><font size="+1"><strong>Login Inv&aacute;lido </strong></font></p>
        <p>Senha ou usu&aacute;rio inv&aacute;lido.</p>
        <form name="form1" method="post" action="index.php">
          <input class="css_btn_anteior" type="submit" value="Recomeçar">
        </form>
        <p>&nbsp;</p>
