...
// If so, modify the $PHPTHUMB_CONFIG['mysqli_query'] line to suit your database structure
...
$PHPTHUMB_CONFIG['mysqli_query'] = '';
//$PHPTHUMB_CONFIG['mysqli_query'] = 'SELECT `picture` FROM `products` WHERE (`id` = \''.mysqli_escape_string(@$_GET['id']).'\')';

// These 4 values must be modified if $PHPTHUMB_CONFIG['mysqli_query'] is not empty, but may be ignored if $PHPTHUMB_CONFIG['mysqli_query'] is blank.
$PHPTHUMB_CONFIG['mysqli_hostname'] = 'localhost';
$PHPTHUMB_CONFIG['mysqli_username'] = '';
$PHPTHUMB_CONFIG['mysqli_password'] = '';
$PHPTHUMB_CONFIG['mysqli_database'] = '';
