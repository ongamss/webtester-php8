...
// ============================================================
	function imageChange() {		
		...
		var csize   = document.getElementById('cimg').attributes['csize'].value.explode('|');	// get current size (array)
		var ctype   = document.getElementById('cimg').attributes['ctype'].value.explode('|');	// get current type (array)	
...
// ============================================================
	function renameClick() {
		...
		var cfile = document.getElementById('cimg').attributes['cfile'].value;		
		var ctype = document.getElementById('cimg').attributes['ctype'].value.explode('|');		
	...
	function showInfo() {
		...
		if (document.getElementById('cimg').attributes['cfile'].value != '') {			
			...
			if (oDiv.className == 'showit') {
				...
				ctype = document.getElementById('cimg').attributes['ctype'].value.explode('|'); 
				document.getElementById('inf_ctype').innerHTML   = ctype[1];		
				csize = document.getElementById('cimg').attributes['csize'].value.explode('|');
