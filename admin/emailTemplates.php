  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Email Templates </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; Email Templates <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	 ...
	 for(z=0; z<theForm.length;z++){
	  ...
	  theForm[z].checked = theElement.checked;
        ...
        <form action="deleteEmailTemplates.php" method="post" name="delete" id="delete">
		<p><span class="style7">Email Templates </span></p>
          <table width="100%"  border="0" cellspacing="2" cellpadding="0">
            <tr bgcolor="#EBEBEB">
              <td width="40"><div align="center"><a href="addEmailTemplate.php"><img src="../images/new.gif" alt="New Template" width="19" height="18" border="0" title="New Template"></a></div></td>
            ...
            <?php
$templateSQL="SELECT * FROM emailtemplates ORDER by ID";
...
<table span class="style1 style5"width="100%"  border="0" cellspacing="2" cellpadding="0" onMouseOut="javascript:highlightTableRowVersionA(0);">
  <tr bgcolor="#C8D8FF">
    ...
    <td width="350" align="center"><span class="style1 style5">Name</span></td>
    <td align="center"><span class="style1 style5">Description</span></td>
  </tr>
<?php
	$i = 0;
	...
	<?php
		...
		echo("<td align='left'><A class='pointer' HREF='editEmailTemplate.php?ID=" . $row['ID'] . "'>" . $row['Name'] . "</A></td>");
