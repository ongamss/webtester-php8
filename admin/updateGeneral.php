...
?>
    ...
    <tr> 
	  ...
	  $prefSQL="UPDATE preferences SET
	  AllowBrowse='" . $_POST['allowBrowse'] . "',
	  mimetex='" . $_POST['mimetex'] . "',
	  notes='" . addslashes($_POST['notes']) . "',
	  WelcomeMessage='" . addslashes($_POST['welcome']) . "'";
	  $result=mysqli_query($conn, $prefSQL)
	  	or die("Invalid Query: " . $prefSQL . " - " . mysqli_error());
