  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" --> 
        <p class="style4">Delete Subjects </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./subjects.php">Subject Management</a> &gt; Delete Subjects <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->
		...
		if (isset($_POST['confirm']) && $_POST['confirm']==1) {
			...
			for ($i = 0; $i < count($_POST['delete']); $i++) {
				...
				$subjectSQL="DELETE FROM subjects WHERE ID=" . $_POST['delete'][$i];
				$myRs=mysqli_query($conn, $subjectSQL)
					or die("Invalid Query: " . $subjectSQL . " - " . mysqli_error());
			}
			redirect_to("subjects.php");
		}
		?>
		<span class="style7">Delete Subjects </span></p>
		<p>Are you sure you want to delete the following subjects?</p>
  ...
  <tr bgcolor="#C8D8FF">
    ...
    <td align="left" class="style1 style5">Name</td>
          ...
          <?php
	for ($i = 0; $i < count($_POST['delete']); $i++) {
		$subjectSQL="SELECT * FROM subjects WHERE ID=" . $_POST['delete'][$i];
		$myRsRes=mysqli_query($conn, $subjectSQL);
