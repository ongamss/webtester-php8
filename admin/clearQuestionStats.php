  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Clear Question Statistics </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="./index.php">WebTester</a> &gt; Question Statistics <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	  ...
	  $questionSQL="UPDATE questions SET
	  Correct='0',
	  Incorrect='0',
	  A1Clicks='0',
	  A2Clicks='0',
	  ...
	  echo($questionSQL);
	  $result=mysqli_query($conn, $questionSQL)
	  	or die("Invalid Query: " . $questionSQL . " - " . mysqli_error());
	  redirect_to("questionStats.php?TestID=" . $_REQUEST['TestID']);
		?>
