...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="./index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; <a href="./accountManage.php">User Accounts</a> &gt; Add User <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
        ...
        <form name="form1" method="post" action="insertUser.php">
          <table class="style1" width="100%"  border="0" cellspacing="2" cellpadding="0" onMouseOut="javascript:highlightTableRowVersionA(0);">
            <tr class="d0" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              ...
              <td><input name="txtUsername" type="text" id="txtUsername" value="<?=$_REQUEST['username']?>"></td>
            </tr>
            <tr class="d1" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              <td width="172">Password:</td>
              <td><input name="txtPassword" type="password" id="txtPassword"><?php if ($_REQUEST['error']=="password") echo("<font color=red>Passwords did not match</font>");?></td>
            </tr>
            <tr class="d0" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
            ...
            <tr class="d1" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              ...
              <td><input name="firstname" type="text" id="firstname" value="<?=$_REQUEST['firstname']?>"></td>
            </tr>
            <tr class="d0" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              <td width="172">Last Name: </td>
              <td><input name="lastname" type="text" id="lastname" value="<?=$_REQUEST['lastname']?>"></td>
            </tr>
            <tr class="d1" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              <td width="172">Location (Optional):</td>
              <td><input name="txtLocation" type="text" id="txtLocation" value="<?=$_REQUEST['location']?>"></td>
            </tr>
            <tr class="d0" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
            ...
            <tr class="d1" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              ...
              <td><p>
                    <input name="limited" type="radio" value="all" checked>
                All<br>
                  <input name="limited" type="radio" value="limited">
                Limited</p>
				<p>
				<?php
				...
				?>
                <input name='subject[]' type='checkbox' value='<?=$row['ID']?>'><?=$row['Name']?><br>
				<?php
					}
				}
				?>
            ...
            <tr class="d0" onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFF99');">
              ...
              <td><input name="admin" type="checkbox" id="admin" value="admin"></td>
            </tr>
            <tr>
