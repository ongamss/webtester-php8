  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" --> 
        <p class="style4">Deletar Modelo de Relatorio </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; <a href="./reportTemplates.php">Report Templates</a> &gt; Delete Report Templates <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->
		...
		if (!isset($_POST['delete'])) {
			redirect_to("reportTemplates.php");
			exit;
		}
		...
		if (isset($_POST['confirm']) && $_POST['confirm']==1) {
			...
			for ($i = 0; $i < count($_POST['delete']); $i++) {
				...
				$emailSQL="DELETE FROM reporttemplates WHERE ID=" . $_POST['delete'][$i];
				$myRs=mysqli_query($conn, $emailSQL)
					or die("Invalid Query: " . $emailSQL . " - " . mysqli_error());
			}
			redirect_to("reportTemplates.php");
		}
		?>
		<span class="style7">Delete Report Templates </span></p>
		<p>Are you sure you want to delete the following templates?</p>
  ...
  <tr bgcolor="#C8D8FF">
    ...
    <td align="left" class="style1 style5">Name</td>
          ...
          <?php
	for ($i = 0; $i < count($_POST['delete']); $i++) {
		$emailSQL="SELECT * FROM reporttemplates WHERE ID=" . $_POST['delete'][$i];
		$myRsRes=mysqli_query($conn, $emailSQL);
