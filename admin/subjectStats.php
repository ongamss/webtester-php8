  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Subject Statistics </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="./index.php">WebTester</a> &gt; <a href="./subjects.php">Subjects</a><a href="./questionEdit.php?TestID=<?=$_REQUEST['TestID']?>"></a> &gt; Subject Statistics <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->
		...
		$subjectSQL="SELECT * FROM subjects ORDER BY 'Name' ASC, 'ID' ASC";
		require_once("../includes/graphs.inc.php");
		$subjectResult=mysqli_query($conn, $subjectSQL);
		$num_rows=mysqli_num_rows($subjectResult);
		?>
		<p class="style7">Subject Statistics</p>
...
<?php
  ...
  <tr bgcolor="#C8D8FF">
    ...
    <td width="170" align="center" class="style1 style5">Percent</td>
  </tr>
	<?php
$i++;
...
?></td>
	...
	?>
	    ...
	    <div align="center"><span class="style1"><a href="clearSubjectStats.php">Clear Subject Statistics</a> </span></div>
