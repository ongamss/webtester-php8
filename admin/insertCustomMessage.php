  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Add Custom Message </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; <a href="./reportTemplates.php">Report Templates</a> &gt; <a href="./editReportTemplate.php?ID=<?=$_REQUEST['reportID']?>">Edit Report Template</a> &gt; Adding Custom Message... <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	 ...
	 $_POST['desc']=str_replace("'","&#39;",$_POST['desc']);
	  ...
	  $customMessageSQL="INSERT INTO CustomMessages
	  	(ReportID,
	  	Description,
		Message,
	  	MinPoints,
		...
		VALUES
	  	...
	  	'" . intval($_POST['minPoints']) . "',
		'" . intval($_POST['maxPoints']) . "')";
	  $result=mysqli_query($customMessageSQL, $conn)
