  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Prefer&ecirc;ncias</p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; Prefer&ecirc;ncias <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->
	  <?php
	  	if ($_SESSION['loggedIn'] != "1") {
			redirect_to("index.php?ref=preferences.php");
			exit;
		}
	  ?>
        <p class="style7 style1">Prefer&ecirc;ncias</p>
        <table width="600"  border="0" cellpadding="0" cellspacing="2" class="style1" align="center">
          <tr>
            <td><div align="center">
              <p align="left"><a href="./general.php"><img src="../images/general.png" width="48" height="48" border="0" align="left"><br>
                Geral</a></p>
              <p>&nbsp;</p>
            </div></td>
            <td><div align="center">
              <p align="left"><a href="./emailTemplates.php"><img src="../images/emailtemplate.png" width="48" height="48" border="0" align="left"><br>
                Modelos de Email</a></p>
              <p>&nbsp;</p>
            </div></td>
          </tr>
          <tr>
            <td><div align="center">
              <p align="left"><a href="./accountManage.php"><img src="../images/users.png" width="48" height="48" border="0" align="left"><br>
                Contas de Usu&aacute;rios</a> </p>
              <p>&nbsp;</p>
            </div></td>
            <td><div align="center">
              <p align="left"><a href="./reportTemplates.php"><img src="../images/reporttemplate.png" width="48" height="48" border="0" align="left"><br>
                Modelos de Relat&oacute;rios </a></p>
              <p>&nbsp;</p>
            </div></td>
          </tr>
        </table>
