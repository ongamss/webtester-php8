...
<div align="center"> 
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Modelo de Relat&oacute;rio </p>
  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
	...
	if (isset($_SESSION['loggedInName'])) {
		...
		?>
          <div align="center">Atualmente logando como:
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; Modelo de Relat&oacute;rio <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	 ...
	 for(z=0; z<theForm.length;z++){
	  ...
	  theForm[z].checked = theElement.checked;
        ...
        <form action="deleteReportTemplates.php" method="post" name="delete" id="delete">
		<p><span class="style7">Modelo de Relat&oacute;rio </span></p>
          <table width="100%"  border="0" cellspacing="2" cellpadding="0">
            <tr bgcolor="#EBEBEB">
              <td width="40"><div align="center"><a href="addReportTemplate.php"><img src="../images/new.gif" alt="New Template" width="19" height="18" border="0" title="New Template"></a></div></td>
              <td width="40"><div align="center">
                <input type="image" alt="Delete Selected Templates" value="Delete Selected Templates" id="Del" name="Del" src="../images/delete.png" width="18" height="18" title="Delete Selected Templates">
              </div></td>
              <td class="style1 style5">&nbsp;</td>
              </tr>
          </table>
            <?php
$templateSQL="SELECT * FROM reporttemplates ORDER by ID";
$result=mysqli_query($conn, $templateSQL);
...
<table span class="style1 style5"width="100%"  border="0" cellspacing="2" cellpadding="0" onMouseOut="javascript:highlightTableRowVersionA(0);">
  <tr bgcolor="#C8D8FF">
    ...
    <td width="65" align="center"><span class="style1 style5">ID</span></td>
    <td width="350" align="center"><span class="style1 style5">Nome</span></td>
    <td align="center"><span class="style1 style5">Descri&ccedil;&atilde;o</span></td>
  </tr>
<?php
	$i = 0;
	...
	<?php
		...
		echo("<td align='left'><A class='pointer' HREF='editReportTemplate.php?ID=" . $row['ID'] . "'>" . $row['Name'] . "</A></td>");
