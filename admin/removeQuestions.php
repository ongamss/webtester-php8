...
?>
    ...
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" --> 
		...
		?>
        <p><strong>Remove Questions:</strong> (<?=$num_rows?> Questions)</p>
		...
		?>
		  			<li><input name="delete[]" type="checkbox" value="<?=$row['ID']?>"> <?=$i . "."?> <?=$row['QuestionText']?></li>
            <?php
			$i++;
			}
			?>
		...
		?>
            <input type="submit" name="Submit" value="Remove Selected Questions">
