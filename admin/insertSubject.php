...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./subjects.php">Subject Management</a> &gt; <a href="./addSubject.php">Create New Subject </a> &gt; Adding... <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
...
<?php
     ...
     $_POST['description']);
		...
		$subjectSQL="INSERT INTO subjects
			(Name,
			Description,
			Correct,
			Incorrect)
