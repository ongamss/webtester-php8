  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" --> 
        <p class="style4">Delete Email Templates </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; <a href="./preferences.php">Preferences</a> &gt; <a href="./emailTemplates.php">Email Templates</a> &gt; Delete Email Templates <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->
		...
		if (!isset($_POST['delete'])) {
			redirect_to("emailTemplates.php");
			exit;
		}
		...
		if (isset($_POST['confirm']) && $_POST['confirm']==1) {
			...
			for ($i = 0; $i < count($_POST['delete']); $i++) {
				...
				$emailSQL="DELETE FROM emailtemplates WHERE ID=" . $_POST['delete'][$i];
		...
		?>
		<span class="style7">Delete Email Templates </span></p>
  ...
  <tr bgcolor="#C8D8FF">
    ...
    <td align="left" class="style1 style5">Name</td>
          ...
          <?php
	for ($i = 0; $i < count($_POST['delete']); $i++) {
		$emailSQL="SELECT * FROM emailtemplates WHERE ID=" . $_POST['delete'][$i];
