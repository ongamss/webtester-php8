...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" -->WebTester &gt; Preferences &gt; User Accounts &gt; Edit User <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	  ...
	  if($_POST['Password']!=$_POST['ConfirmPassword']) {
	  	redirect_to("editUser.php?error=password&UserID=" . $_POST['UserID']);
		exit;
	  }
	  ...
	  if($_POST['Password']!="") { 
		  ...
		  Admin='" . $admin . "',
		  Limited='" . $limited . "',
		  LimitedSubjects='" . $limitedsubjects . "',
		  Attempts='" . $_POST['Attempts'] . "',
		  Location='" . $_POST['Location'] . "'
		  WHERE ID='" . $_POST['UserID']. "'";
		  $result=mysqli_query($conn, $usersSQL)
		  	or die("Invalid Query: " . $usersSQL . " - " . mysqli_error($conn));
