  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Gerenciamento de Assunto</p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; Gerenciador de Assuntos <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
	 ...
	 for(z=0; z<theForm.length;z++){
	  ...
	  theForm[z].checked = theElement.checked;
		...
		<p><span class="style7">Assuntos</span></p>
...
<table span class="style1 style5"width="100%"  border="0" cellspacing="2" cellpadding="0" onMouseOut="javascript:highlightTableRowVersionA(0);">
  <tr bgcolor="#C8D8FF">
    ...
    <td width="450" align="center"><a href="./subjects.php?sort=Name&order=ASC&view=<?=$_REQUEST['view']?>"><span class="style1 style5">Assunto</span><br>
    ...
    <td align="center"><span class="style1 style5"><a href="./subjects.php?sort=Description&order=ASC&view=<?=$_REQUEST['view']?>">Descri&ccedil;&atilde;o<br>
