  ...
  <table width="100%" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" BORDERCOLORLIGHT="#999999" BORDERCOLORDARK="#333333">
    <tr> 
      ...
      <td align="center" valign="middle"><!-- InstanceBeginEditable name="CurrentArea" -->
        <p class="style4">Create New Report Template </p>
...
?>
		   ...
		   <!-- InstanceBeginEditable name="nav" --><a href="index.php">WebTester</a> &gt; Adding... <!-- InstanceEndEditable --></div></td>
    </tr>
    <tr> 
      <td align="center" valign="top">		<div align="left"><!-- InstanceBeginEditable name="Content Area" -->Adding <?=$_POST['name']?>
<?php
	 ...
	 $_POST['description']=preg_replace('/\[tex\](.*?)\[\/tex\]/ie',
     "'<img src=\"" . $pref['mimetex'] . "?'.rawurlencode('$1').'\" align=\"middle\" />'",
     $_POST['description']);
	 
	 $_POST['text']=preg_replace('/\[tex\](.*?)\[\/tex\]/ie',
     "'<img src=\"" . $pref['mimetex'] . "?'.rawurlencode('$1').'\" align=\"middle\" />'",
     $_POST['text']);
		
		$emailSQL="INSERT INTO ReportTemplates
			(Name,
			Description,
			Text)
			VALUES
